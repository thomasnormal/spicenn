...
\]
emits four small Level-1 MOS decks under
...
\begin{figure}[H]
  ...
  \caption{Ngspice DC characterization of the MOS forward differential pair.
  The diode-connected load is voltage-inverting, so the useful signed load
  voltage is plotted as \(h^- - h^+\).  It is monotone and bounded over the
  operating sweep, matching the required tanh-like activation shape.}
