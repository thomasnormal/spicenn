...
\begin{figure}[H]
  ...
  \caption{Ngspice DC characterization of the signed synapse slice.  The
  plotted current uses the mathematical contribution convention: a high
  \(w^+\) rail gives a positive contribution for \(x^+>x^-\), while a high
  \(w^-\) rail reverses the sign.}
