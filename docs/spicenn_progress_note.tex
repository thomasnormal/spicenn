...
\begin{figure}[H]
  ...
  pulse-width sweep verifies near-linear selected write magnitude while the
  inactive branch stays quiet.  The readback panel then uses the written \(W^+\)
  and \(W^-\) voltages as positive- and negative-weight synapse tail gates,
  verifying opposite signed contribution changes from the stored capacitor
  rails.}
