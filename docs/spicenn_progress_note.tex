...
\begin{figure}[H]
  ...
  Same-sign input/error coincidence charges only the \(W^+\) storage capacitor;
  opposite-sign coincidence charges only \(W^-\).  This validates update-branch
  selectivity and write polarity, not yet calibrated analog write linearity.}
