...
def row_from_summary(path: Path) -> dict[str, Any]:
    ...
    row = {
        ...
        "train_order": data.get("train_order", "stable"),
        "train_order_window": data.get("train_order_window"),
        "train_order_pca_components": data.get("train_order_pca_components"),
        "train_order_pca_bins_per_unit": data.get("train_order_pca_bins_per_unit"),
