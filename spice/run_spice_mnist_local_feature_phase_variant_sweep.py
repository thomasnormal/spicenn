...
def build_variant_command(
    ...
    command = [
        ...
        "--hidden-delta-mode",
        getattr(args, "hidden_delta_mode", DEFAULT_HIDDEN_DELTA_MODE),
        "--score-state-mode",
...
def main() -> None:
    ...
    ap.add_argument("--phase-clock-mode", choices=["pwl", "analytic", "smooth-analytic", "pulse-gated"], default="pwl")
    ...
    ap.add_argument("--hidden-delta-mode", choices=["stored", "inline"], default=DEFAULT_HIDDEN_DELTA_MODE)
