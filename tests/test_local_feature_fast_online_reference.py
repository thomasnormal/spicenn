...
def test_fast_online_variant_sweep_row_reports_best_probe_and_improvement() -> None:
    ...
    assert command[command.index("--max-auxiliary-algebraic-sources") + 1] == "0"
    ...
    assert row["strict_phase_promotion_hidden_delta_mode"] == "stored"
...
def test_fast_online_strict_promotion_defaults_to_pwl_clock_and_efficient_deck_shape() -> None:
    ...
    assert fields["strict_phase_promotion_hidden_delta_mode"] == "stored"
...
def test_fast_online_strict_promotion_keeps_output_rails_when_printing_y() -> None:
    args = argparse.Namespace(
        promotion_output_rail_mode="inline",
        promotion_phase_output_include_y=True,
    )

    assert fast_sweep.effective_promotion_output_rail_mode(args) == "node"
...
def test_fast_online_strict_promotion_sample_edge_is_projected_separately() -> None:
    args = argparse.Namespace(
        ...
        promotion_max_auxiliary_algebraic_sources=20,
    ...
    args.promotion_sample_edge = 5e-12
    ...
    assert finite["strict_phase_promotion_hidden_delta_mode"] == "stored"
    ...
    assert sharp["strict_phase_promotion_hidden_delta_mode"] == "stored"
...
def test_fast_online_strict_cost_projection_can_use_a_different_horizon() -> None:
    args = argparse.Namespace(
        ...
        promotion_max_auxiliary_algebraic_sources=1,
        promotion_phase_clock_mode="pwl",
        promotion_target_source_mode="label",
        promotion_phase_output_include_y=False,
        image_size=2,
    ...
    assert projection["strict_phase_cost_projection_auxiliary_algebraic_source_count"] == promotion["strict_phase_promotion_auxiliary_algebraic_source_count"]
    assert projection["strict_phase_cost_projection_auxiliary_algebraic_source_budget_met"] is True
...
def test_fast_online_variant_sweep_marks_full_objective_candidates_as_fast_reference_only() -> None:
    ...
    rows = [
        {
            ...
            "strict_phase_cost_projection_auxiliary_algebraic_source_budget_met": True,
        ...
        {
            "tag": "too_many_sources",
            "final_eval_accuracy": 0.905,
            "eval_improvement": 0.5,
            "strict_phase_cost_projection_transient_budget_met": True,
            "strict_phase_cost_projection_source_pwl_budget_met": True,
        ...
        },
        {
            ...
            "strict_phase_cost_projection_output_vector_budget_met": True,
            "strict_phase_cost_projection_auxiliary_algebraic_source_budget_met": False,
            "strict_phase_cost_projection_updates": 10000,
    ...
    assert fast_sweep.cost_projection_summary_fields(rows, cost_projection_updates=10000) == {
        ...
        "cost_projection_auxiliary_algebraic_source_budget_feasible_rows": 4,
        ...
        "fast_reference_full_objective_auxiliary_algebraic_source_budget_infeasible_count": 1,
    }
    assert fast_sweep.cost_projection_summary_fields([], cost_projection_updates=0) == {
        ...
        "cost_projection_auxiliary_algebraic_source_budget_feasible_rows": 0,
        ...
        "fast_reference_full_objective_output_vector_budget_infeasible_count": 0,
        "fast_reference_full_objective_auxiliary_algebraic_source_budget_infeasible_count": 0,
    }
...
def test_fast_online_variant_sweep_prefers_budget_feasible_promotion_variant() -> None:
    rows = [
        ...
        },
        {
            "tag": "too_many_sources",
            "final_eval_accuracy": 0.95,
            "promotion_probe_eval_accuracy": 0.9,
        ...
        {
            "tag": "too_many_auxiliary_sources",
            "final_eval_accuracy": 0.97,
            "promotion_probe_eval_accuracy": 0.92,
            "eval_improvement": 0.92,
            "strict_phase_promotion_transient_budget_met": True,
            "strict_phase_promotion_source_pwl_budget_met": True,
            "strict_phase_promotion_output_vector_budget_met": True,
            "strict_phase_promotion_auxiliary_algebraic_source_budget_met": False,
        },
    ]
